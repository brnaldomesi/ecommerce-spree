...
ActiveRecord::Schema.define(version: 2019_07_15_151858) do
  ...
  create_table "users_resource_actions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci", force: :cascade do |t|
    t.integer "user_id"
